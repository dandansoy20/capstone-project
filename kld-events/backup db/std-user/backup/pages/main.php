      ...
      <div class="col-lg-12">
        <div class="page-content">
            ...
            <div class="row">
              <div class="col-lg-7">
                <div class="header-text">
                  <h6>Welcome To KLD Events</h6>
                  <h4><em>Browse</em> Some Exciting Events</h4>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="heading-section">
                  <h4><em>For You</em> Events</h4>
                </div>
                <div class="row">
                  <div class="col-lg-3 col-sm-6">
                    <div class="item">
                      <img src="assets/images/popular-01.jpg" alt="">
                      <h4>IS Week 2024<br><span>Sandbox</span></h4>
                      <ul>
          ...
          <div class="gaming-library">
            <div class="col-lg-12">
              <div class="heading-section">
                <h4><em>Your Attended</em> Events</h4>
              </div>
              <div class="item">
                <ul>
                  <li><img src="assets/images/game-01.jpg" alt="" class="templatemo-item"></li>
                  <li><h4>IS Week 2024</h4><span>Sandbox</span></li>
                  <li><h4>When</h4><span>24/08/2036</span></li>
                  <li><h4>Hours Played</h4><span>634 H 22 Mins</span></li>
                  <li><h4>Currently</h4><span>Downloaded</span></li>
                  <li><div class="main-border-button border-no-active"><a href="#">Rated</a></div></li>
                </ul>
              </div>
              <div class="item">
                <ul>
                  ...
                  <li><h4>Currently</h4><span>Downloaded</span></li>
                  <li><div class="main-border-button"><a href="#">Rate Now</a></div></li>
                </ul>
              </div>
