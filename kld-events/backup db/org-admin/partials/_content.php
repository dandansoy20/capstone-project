				...
				<div class="card card-custom card-stretch gutter-b">
					...
					<div class="card-body d-flex align-items-center py-0 mt-8">
						<div class="d-flex flex-column flex-grow-1 py-2 py-lg-5">
							<a href="?page=profile"
								class="card-title font-weight-bolder text-dark-75 font-size-h5 mb-2 text-hover-primary">Hello, Fname!</a>
							<span class="font-weight-bold text-muted  font-size-lg">Organization Here</span>
						</div>
		...
		<div class="row">
			<div class="col-xl-3">
				...
				<div class="card card-custom card-stretch gutter-b">
					...
					<div class="card-header border-0">
						<h3 class="card-title font-weight-bolder text-dark">My Team</h3>
					</div>
					<!--end::Header-->
					<!--begin::Body-->
			...
			<div class="col-xl-3">
				...
				<div class="card card-custom card-stretch gutter-b">
					<!--begin::Header-->
					<div class="card-header border-0">
						<h3 class="card-title font-weight-bolder text-dark">Org Members</h3>
					</div>
					<!--end::Header-->
					<!--begin::Body-->
					<div class="card-body pt-2">
