					...
					<div class="d-flex justify-content-between flex-column pt-4 h-100">
						...
						<div class="pb-5">
							...
							<div class="d-flex flex-column flex-center">
								...
								<!--begin::Username-->
								<a href="#" class="card-title font-weight-bolder text-dark-75 text-hover-primary font-size-h4 m-0 pt-7 pb-1">Hi, <?php echo $_SESSION['kld_fname'] ?></a>
								<!--end::Username-->
		...
		<div class="col-xl-3">
			...
			<div class="card card-custom card-stretch gutter-b">
				<div class="card-body d-flex p-0">
					<div class="flex-grow-1 bg-primary p-8 card-rounded flex-grow-1 bgi-no-repeat" style="background-position: calc(100% + 0.5rem) bottom; background-size: auto 70%; background-image: url(assets/media/svg/humans/custom-3.png)">

						<h4 class="text-inverse-danger mt-2 font-weight-bolder">Regal Morning!</h4>

						<p class="text-inverse-danger my-6">
							Ready to participate<br>to some exciting Events?
						</p>

						<a href="?page=upcoming-events&id=<?php echo $_SESSION['kld_id'] ?>" class="btn btn-warning font-weight-bold py-2 px-6">View Events</a>
					</div>
				</div>
			</div>
			<!--end::Engage Widget 3-->
				...
				<div class="card-body">
					...
					<div class="d-flex align-items-center">
						...
						<div class="symbol symbol-45 symbol-light mr-5">
							<span class="symbol-label">
								<span class="svg-icon svg-icon-lg svg-icon-primary"><!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/General/Clipboard.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
						...
						<!--begin::Info-->
						<div class="d-flex flex-column flex-grow-1">
							<a href="#" class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder">WWII Quiz Pt 14</a>
							<div class="d-flex">
								<div class="d-flex align-items-center pr-5">
									<span class="svg-icon svg-icon-md svg-icon-primary pr-1"><!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/Home/Clock.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
										...
										</svg><!--end::Svg Icon--></span> <span class="text-muted font-weight-bold">Due 04 Sep</span>
								</div>
								<div class="d-flex align-items-center">
									<span class="svg-icon svg-icon-md svg-icon-primary pr-1"><!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/Layout/Layout-arrange.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
										...
										</svg><!--end::Svg Icon--></span> <span class="text-muted font-weight-bold">P1 U.S. History</span>
								</div>
							</div>
						</div>
						<!--end::Info-->
					...
					<div class="pt-3">
						...
						<!--begin::Image-->
						<div class="bgi-no-repeat bgi-position-center bgi-size-cover rounded min-h-295px w-100" style="background-image: url(assets/media/books/12.png)"></div>
						<!--end::Image-->

						<!--begin::Action-->
						<div class="pt-6">
							<a href="#" class="btn btn-light-primary btn-sm rounded font-weight-bolder font-size-sm p-2">
								<span class="svg-icon svg-icon-md pr-2"><!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/Communication/Group-chat.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
									...
									</svg><!--end::Svg Icon--></span> 24 Comments
							</a>
						</div>
						<!--end::Action-->
						...
						<div class="d-flex pt-6">
							...
							<div class="symbol symbol-40 symbol-light-success mr-5 mt-1">
								<span class="symbol-label">
									<img src="/metronic/theme/html/demo1/dist/assets/media/svg/avatars/003-girl-1.svg" class="h-75 align-self-end" alt="">
								</span>
							</div>
							<!--end::Symbol-->
					...
					<!--begin::Editor-->
					<form class="position-relative">
						<textarea id="kt_forms_widget_11_input" class="form-control border-0 p-0 pr-10 resize-none" rows="1" placeholder="Any Question?" style="overflow: hidden; overflow-wrap: break-word; height: 20px;"></textarea>
