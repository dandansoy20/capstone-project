                    ...
                    <div class="card-body pt-4">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <div class="text-muted">
                                    <?php echo $_SESSION['kld_org'] . ", " . $_SESSION['kld_role']; ?>
                                </div>
                            </div>
                        </div>
                        <!--end::User-->
                        ...
                        <div class="py-9">
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                ...
                                <span class="text-muted"><?php echo $_SESSION['kld_emp_id']; ?></span>
                            </div>
                            <div class="d-flex align-items-center justify-content-between">
                                <span class="font-weight-bold mr-2">Course:</span>
                                <span class="text-muted"><?php echo $_SESSION['kld_org']; ?></span>
                            </div>
                        </div>
                        <!--end::Contact-->
                ...
                <div class="card card-custom card-stretch">
                    ...
                    <div class="card-header py-3">
                        ...
                        <div class="card-toolbar">
                            <button type="button" class="btn btn-success mr-2" onclick="swal.fire({ title: 'Under Development', text: 'This part is under development', icon: 'success', confirmButtonText: 'Close' });">Save Changes</button>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-6">
                                    <div class="input-group input-group-lg input-group-solid">
                                        ...
                                        <input type="text" class="form-control form-control-lg form-control-solid"
                                            value="<?php echo $_SESSION['kld_emp_id'] ?>" disabled placeholder="ID Number" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-6">
                                    <div class="input-group input-group-lg input-group-solid">
                                        <input type="text" class="form-control form-control-lg form-control-solid"
                                            placeholder="Program" disabled value="<?php echo $_SESSION['kld_org'] ?>" />
                                    </div>
                                </div>
                            </div>
                        </div>
