								...
								<div class="tab-pane fade show active" id="gallery-4" role="tabpanel" aria-labelledby="gallery-tab-4">
									<div class="row">
										...
										?>
												...
												<div class="card card-custom gutter-b">
													...
													<div class="card-body">
														...
														<div class="pt-4">
															...
															<!--begin::Image-->
															<div class="bgi-no-repeat bgi-size-cover rounded" data-toggle="modal" data-target="#galleryModal_<?php echo $image_id; ?>" style="background-image: url(<?php echo $event_image; ?>); width: 100%; padding-bottom: 100%;"></div>
															<!--end::Image-->
											...
											<div class="modal fade" id="galleryModal_<?php echo $image_id; ?>" tabindex="-1" role="dialog" aria-labelledby="imageModalLabel" aria-hidden="true">
												<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
													<div class="modal-content">
														<div class="modal-header">
															<button type="button" class="close" data-dismiss="modal" aria-label="Close">
														...
														<div class="modal-body text-center">
															<img src="<?php echo $event_image; ?>" class="img-fluid" alt="Full Preview">
														</div>
													</div>
												</div>
											</div>
