...
if (!array_key_exists('ajax', $_GET)) {
    ...
    if ($_GET['ajax'] == "account_activation") {
        ...
        $_SESSION['kld_email'] = "";
        $try = mysqli_query($conn, "Select * from emp_acc where emp_activation_key = '" . $_SESSION['activation_key'] . "'");
        while ($row = $try->fetch_array()) {
            echo "";
            $_SESSION['kld_id'] = $row['emp_kld_id'];
...
-->
        ...
        <body id="kt_body"
            ...
            <?php include("../admin/partials/_page-loader.php"); ?>
            <!--begin::Main-->
                    ...
                    <div class="d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid"
                        ...
                        <div class="login-form text-center text-white p-7 position-relative overflow-hidden">
                            ...
                            <div class="login-signin">
                                <div class="mb-20">
                                    <h3 class="opacity-40 font-weight-normal">Employee Sign Up</h3>
