...
<head>
	<base href="">
	<meta charset="utf-8" />
	<title> KLD Events | Student Login </title>
					...
					<div class="login-signin">
						...
						<form class="form" id="kt_login_signin_form">
							<div class="form-group">
								<input class="form-control h-auto text-white placeholder-white opacity-70 bg-dark-o-70 rounded-pill border-0 py-4 px-8 mb-5" type="text" required placeholder="username" id="std_username" name="username" autocomplete="off" />
							</div>
							<div class="form-group">
								<input class="form-control h-auto text-white placeholder-white opacity-70 bg-dark-o-70 rounded-pill border-0 py-4 px-8 mb-5" type="password" required placeholder="password" id="std_password" name="password" />
							...
							<div class="form-group text-center mt-10">
								<button id="login_std" type="button" class="btn btn-pill btn-outline-white font-weight-bold opacity-90 px-15 py-3">Sign In</button>
							</div>
						</form>
					</div>
