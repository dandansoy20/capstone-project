  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div
      ...
      <a href="#" class="logo d-flex align-items-center">
        ...
        <h1 class="sitename">KLD Events</h1>
      </a>
      ...
      <div class="container">
        <div class="row gy-4 justify-content-between">
          ...
          <div
            ...
            data-aos="fade-in">
            <h1>Welcome to <span>KLD Events</span></h1>
            <p>
              A page dedicated for events at Kolehiyo ng Lungsod ng Dasmariñas
            </p>
            <div class="d-flex">
          ...
          <div class="overlay-container">
            <div class="overlay">
              <div class="overlay-panel overlay-left">
                ...
                <p class="login-p">Enter your ID number and create your username and password.</p>
                <button type="button" id="signIn" class="ghost btn btn-pill btn-outline-white px-15 py-3 m-2">Student</button>
              </div>
              <div class="overlay-panel overlay-right">
                <h1 class="display-3" style="color: #ffffff">Welcome Regals!</h1>
                <p class="login-p">To get started, please log in to your account.</p>
                <button type="button" id="signUp" class="ghost btn btn-pill btn-outline-white px-15 py-3 m-2">Employee</button>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        <div class="row align-items-xl-center gy-5">
          <div class="col-xl-5 content">
            <h3>About Us</h3>
            <h2>What is KLD Events?</h2>
            <p>
              We're a passionate team dedicated to revolutionizing the way events and gatherings are experienced. Our mission is to create memorable, seamless, and enriching experiences for both organizers and attendees. By leveraging cutting-edge technology and innovative solutions, we aim to bring people together in meaningful ways, fostering connections and creating lasting memories.
            </p>
            ...
            <div class="row gy-4 icon-boxes">
              <div class="col-md-6" data-aos="fade-up" data-aos-delay="200">
                <div class="icon-box">
                  ...
                  <h3>Accessible Event Information</h3>
                  <p>
                    Access all the essential event details, like venue, date and time, activities and agenda, right at your fingertips.
                  </p>
                </div>
              </div>
              <!-- End Icon Box -->
              ...
              <div class="col-md-6" data-aos="fade-up" data-aos-delay="300">
                <div class="icon-box">
                  ...
                  <p>
                    Receive timely reminders and important updates so you never miss a crucial moment.
                  </p>
                </div>
              </div>
              <!-- End Icon Box -->
              ...
              <div class="col-md-6" data-aos="fade-up" data-aos-delay="400">
                <div class="icon-box">
                  ...
                  <p>
                    Navigate the platform effortlessly with an intuitive and easy-to-use design.
                  </p>
                </div>
              </div>
              <!-- End Icon Box -->
              ...
              <div class="col-md-6" data-aos="fade-up" data-aos-delay="500">
                <div class="icon-box">
                  ...
                  <p>
                    Enjoy a hassle-free registration process that gets you into the event quickly and easily.
                  </p>
                </div>
              </div>
              <!-- End Icon Box -->
