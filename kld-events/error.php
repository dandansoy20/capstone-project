...
<head>
	<meta charset="utf-8" />
	<title>KLD Events | Error Page</title>
	...
	<link href="std-user/assets/css/themes/layout/header/base/light.css" rel="stylesheet" type="text/css" />
	<link href="std-user/assets/css/themes/layout/header/menu/light.css" rel="stylesheet" type="text/css" />
	<link href="std-user/assets/css/themes/layout/brand/dark.css" rel="stylesheet" type="text/css" />
	<link href="std-user/assets/css/themes/layout/aside/dark.css" rel="stylesheet" type="text/css" />
	<!--end::Layout Themes-->
...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
	...
	<div class="d-flex flex-column flex-root">
		<!--begin::Error-->
		<div class="d-flex flex-row-fluid bgi-size-cover bgi-position-center" style="background-image: url(assets/img/bg2.jpg);">
			<!--begin::Content-->
			<div class="d-flex flex-row-fluid flex-column justify-content-end align-items-center text-center text-white pb-40">
				...
				<span class="display-4 font-weight-boldest mb-8"></span>
			</div>
			<!--end::Content-->
		</div>
		<!--end::Error-->
