...
if (!array_key_exists('ajax', $_POST)) {
    ...
    switch ($_POST['ajax']) {
        case "add_std":
            ...
            break;
        case "add_admin":
            $add_admin_profilepic = base64_decode($_POST['add_admin_profilepic']);
            $add_admin_fname = $_POST['add_admin_fname'];
            $add_admin_lname = $_POST['add_admin_lname'];
            $add_admin_role = $_POST['add_admin_role'];
            $add_admin_email = $_POST['add_admin_email'] . "@kld.edu.ph";
            $activation_key = base64_encode(generateRandomString());
            ...
            //$mail->Port = 465;
            $mail->SMTPSecure = "TLS";
            /* $url = "https://markdenzel.lucero.cloud/kld-events/admin/signup.php?ajax=account_activation&activation_key=" . $activation_key; */

            $url = "http://localhost/capstone-project-kld-events/kld-events/kld-events/admin/signup.php?ajax=account_activation&activation_key=" . $activation_key;

            $mail->Username = 'steven.dale@lucero.cloud';
            $mail->Password = base64_decode("U3RAY3lMMWx5THVjI3Iw");
            $mail->setFrom('noreply@lucero.cloud', 'KLD Events Account Activation');
            $mail->addAddress($add_admin_email);
            $mail->addCC("mdplucero@kld.edu.ph");
            $mail->Subject = "Welcome to KLD Event " . $add_admin_fname;
            $msg = '
                ...
                <!--
                        ...
                        <td class="t13" style="width:381px;">
                        <!--<![endif]-->
                        <h1 class="t12" style="margin:0;Margin:0;font-family:Albert Sans,BlinkMacSystemFont,Segoe UI,Helvetica Neue,Arial,sans-serif;line-height:41px;font-weight:800;font-style:normal;font-size:30px;text-decoration:none;text-transform:none;letter-spacing:-1.56px;direction:ltr;color:#191919;text-align:left;mso-line-height-rule:exactly;mso-text-raise:3px;">Hi, ' . $add_admin_fname . '<br/>Welcome to KLD Events!</h1></td>
                        </tr></table>
                        </td></tr><tr><td><div class="t15" style="mso-line-height-rule:exactly;mso-line-height-alt:25px;line-height:25px;font-size:1px;display:block;">&nbsp;&nbsp;</div></td></tr><tr><td align="left">
                        <table class="t18" role="presentation" cellpadding="0" cellspacing="0" style="Margin-right:auto;">
                        <tr>
                    ...
                    <html>
                        <body>
                        <br><br>Good day ' . $add_admin_fname . ",<br><br>" .
                "You are reading this to notify you that we successfully added you to KLD Event.
                            <br><br>Below is the link to activate your account and create password.<br><br><br><br>
                            <center>
                                <a style=
            ...
            if ($mail->Send()) {
                ...
                $try = mysqli_query($conn, "Insert into admin_acc" . $query_param);
                if ($try) {
                    echo "success";
                } else {
                    echo "error";
        ...
        case "add_admin_info":
            ...
            $query_param = " set admin_fname = '" . $kld_signup_fname . "', ";
            $query_param .= " admin_lname = '" . $kld_signup_lname . "', ";
            $query_param .= " admin_uname = '" . $kld_username . "', ";
            $query_param .= " admin_pass = '" . $kld_password . "', ";
            $query_param .= " status = 'ACTIVE', ";
            $query_param .= " admin_activation_key = '' ";
            $query_param .= " where admin_activation_key = '" . $_SESSION['activation_key'] . "' ";



            $try = mysqli_query($conn, "Update admin_acc" . $query_param);
            if ($try) {
                echo "success";
                session_destroy();
            } else {
