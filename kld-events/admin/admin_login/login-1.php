...
<div class="login login-1 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
    <!--begin::Aside-->
    <div class="login-aside d-flex flex-column flex-row-auto" style="background-color: #004c24;">
        <!--begin::Aside Top-->
        <div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
            <!--begin::Aside header-->
            <a href="#" class="text-center mb-10">
				<img src="assets/media/logos/kldlogo.png" class="max-h-70px" alt=""/>
			</a>
            <!--end::Aside header-->
        ...
        <!--begin::Aside Bottom-->
        <div class="aside-img d-flex flex-row-fluid bgi-no-repeat bgi-position-y-bottom bgi-position-x-center" style="background-image: url(assets/media/svg/illustrations/kldbldg.svg)"></div>
        <!--end::Aside Bottom-->
    </div>
    <!--begin::Aside-->
            ...
            <div class="login-form login-signin">
                ...
                <form class="form" novalidate="novalidate" id="kt_login_signin_form">
                    ...
                    <div class="pb-13 pt-lg-0 pt-5">
                        <h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg">Welcome to KLD Events</h3>
                        <span class="text-muted font-weight-bold font-size-h4">Don't have an Account yet? <a href="javascript:;" id="kt_login_signup" class="text-primary font-weight-bolder">Create an Account</a></span>
                    </div>
                    <!--begin::Title-->
