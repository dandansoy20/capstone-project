					...
					<div class="card-body d-flex p-0">
						<div class="flex-grow-1 bg-danger p-8 card-rounded flex-grow-1 bgi-no-repeat" style="background-position: calc(100% + 0.5rem) bottom; background-size: auto 70%; background-image: url(assets/media/svg/humans/custom-3.svg)">
							...
							<p class="text-inverse-danger my-6">
								Ready to create a new<br>and exciting KLD Events.
							</p>
			...
			<div class="col-xl-4">
				...
				<div class="card card-custom card-stretch gutter-b">
					<div class="card-body d-flex p-0 card-rounded">
						<div class="flex-grow-1 p-10 card-rounded flex-grow-1 bgi-no-repeat" style="background-color: #663259; background-position: calc(100% + 0.5rem) bottom; background-size: auto 75%; background-image: url(assets/media/svg/humans/custom-4.svg)">

							<h4 class="text-inverse-danger mt-2 font-weight-bolder">KLD Events Users</h4>

							<div class="mt-5">
								<div class="d-flex mb-5">
									<a href="?page=std" class="d-flex align-items-center text-decoration-none">
										<span class="svg-icon svg-icon-md svg-icon-white flex-shrink-0 mr-3">
											...
											<i class="icon text-white-50 flaticon-users"></i>
											<!--end::Svg Icon-->
										</span>
										<span class="text-white hover-primary">Students</span>
									</a>
								</div>

								<div class="d-flex mb-5">
									<a href="?page=emp" class="d-flex align-items-center text-decoration-none">
										<span class="svg-icon svg-icon-md svg-icon-white flex-shrink-0 mr-3">
											<i class="icon text-white-50 flaticon-users-1"></i>
										</span>
										<span class="text-white hover-primary">Employees</span>
									</a>
								</div>

								<div class="d-flex">
									<a href="?page=organizer" class="d-flex align-items-center text-decoration-none">
										<span class="svg-icon svg-icon-md svg-icon-white flex-shrink-0 mr-3">
											<i class="icon text-white-50 flaticon-user-settings"></i>
										</span>
										<span class="text-white hover-primary">Organizers</span>
									</a>
								</div>
				...
				<div class="card card-custom card-stretch gutter-b">
					...
					<div class="card-body d-flex align-items-center py-0 mt-8">
						<div class="d-flex flex-column flex-grow-1 py-2 py-lg-5">
							...
							<span class="font-weight-bold text-muted  font-size-lg"><?php echo $_SESSION['kld_admin_role'] ?></span>
						</div>
				...
				<a href="?page=completed-events" class="card card-custom bg-success bg-hover-state-success card-stretch gutter-b">
					...
					<div class="card-body">
						...
						<div class="font-weight-bold text-inverse-success font-size-sm">
							<?php
							$try = mysqli_query($conn, "SELECT COUNT(status) FROM `kld_event` where status = 'completed'");
							while ($row = $try->fetch_array()) {
								echo $row[0];
							}
							?>
