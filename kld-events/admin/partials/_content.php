    ...
    <div class=" container ">
						...
						<div class="flex-grow-1 p-8 card-rounded bgi-no-repeat d-flex align-items-center"
							...
							<div class="row">
								...
								<div class="col-12 col-xl-7">
									<h4 class="text-danger font-weight-bolder">How are you?</h4>
									...
									<a href="?page=add-events" class="btn btn-danger font-weight-bold py-2 px-6">Create an Event</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="card card-custom card-stretch gutter-b">
						...
						<div class="card-body d-flex align-items-center py-0 mt-8">
							<div class="d-flex flex-column flex-grow-1 py-2 py-lg-5">
								<a href="?page=profile"
									class="card-title font-weight-bolder text-dark-75 font-size-h5 mb-2 text-hover-primary">Hello, Denzel!</a>
								<span class="font-weight-bold text-muted  font-size-lg">Head of Event Management</span>
							</div>
        ...
        <div class="row">
									<div class="col-xl-4">
										...
										<a href="?page=upcoming-events" class="card card-custom bg-warning bg-hover-state-warning card-stretch gutter-b">
											<!--begin::Body-->
											<div class="card-body">
												...
												<div class="text-inverse-warning font-weight-bolder font-size-h5 mb-2 mt-5">Upcoming Events</div>
												<div class="font-weight-bold text-inverse-warning font-size-sm">25</div>
											</div>
											<!--end::Body-->
										</a>
										<!--end::Stats Widget 13-->
									...
									<div class="col-xl-4">
										...
										<a href="?page=proposal-events" class="card card-custom bg-primary bg-hover-state-primary card-stretch gutter-b">
											<!--begin::Body-->
											<div class="card-body">
												<span class="svg-icon svg-icon-white svg-icon-3x ml-n1">
												...
												<div class="text-inverse-primary font-weight-bolder font-size-h5 mb-2 mt-5">In Process</div>
												<div class="font-weight-bold text-inverse-primary font-size-sm">12</div>
											</div>
											<!--end::Body-->
										</a>
										<!--end::Stats Widget 14-->
									...
									<div class="col-xl-4">
										...
										<a href="?page=completed-events" class="card card-custom bg-success bg-hover-state-success card-stretch gutter-b">
											...
											<div class="card-body">
												...
												<div class="font-weight-bold text-inverse-success font-size-sm">50</div>
											</div>
											<!--end::Body-->
										</a>
										<!--end::Stats Widget 15-->
									...
									<div class="col-xl-3">
										...
										<div class="card card-custom bg-light-success card-stretch gutter-b">
											...
											<div class="card-body">
												...
												<span class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 mt-6 d-block">102</span>
									...
									<div class="col-xl-3">
										...
										<div class="card card-custom bg-light-danger card-stretch gutter-b">
											...
											<div class="card-body">
												...
												<span class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 mt-6 d-block">31</span>
												<span class="font-weight-bold text-muted font-size-sm">Org Members</span>
											</div>
											<!--end::Body-->
										</div>
										<!--end::Stats Widget 26-->
