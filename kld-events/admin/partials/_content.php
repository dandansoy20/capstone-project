        ...
        <div class="row">
                            ...
                            <div class="row m-0">
                                <div class="col bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7">
                                    <span
                                        ...
                                        </svg><!--end::Svg Icon--></span> <a href="?page=events"
                                ...
                                <div class="col bg-light-primary px-6 py-8 rounded-xl mb-7">
                                    <span
                                        ...
                                        </svg><!--end::Svg Icon--></span> <a href="?page=std"
                            ...
                            <div class="row m-0">
                                <div class="col bg-light-danger px-6 py-8 rounded-xl mr-7">
                                    <span
                                        ...
                                        </svg><!--end::Svg Icon--></span> <a href="?page=venue"
                                ...
                                <div class="col bg-light-success px-6 py-8 rounded-xl">
                                    <span
                                        ...
                                        </svg><!--end::Svg Icon--></span> <a href="?page="
                ...
                <div class="card card-custom card-stretch gutter-b">
                    ...
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label font-weight-bolder text-dark">Overview</span>
                            <span class="text-muted mt-3 font-weight-bold font-size-sm">KLD Events</span>
                        </h3>
                            ...
                            <table class="table table-borderless table-vertical-center">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="pl-0 py-4">
                                            <div class="symbol symbol-50 symbol-light mr-1">
                                                <span class="symbol-label">
                                                    <img src="assets/media/svg/misc/006-plurk.sv"
                                        ...
                                        <td class="pl-0">
                                            <a href="#"
                                                class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">IICS
                                                Foundation Week</a>
                                            <div>
                                                <span class="font-weight-bolder">IISCS:</span>
                                                <a class="text-muted font-weight-bold text-hover-primary"
                                                    href="#">Russel Gatdula</a>
                                            </div>
                                        </td>
                                        <td class="text-right">
                                        ...
                                        <td class="text-right pr-0">
                                            <a href="#" class="btn btn-icon btn-light btn-hover-primary btn-sm">
                                                <span
                                                    class="svg-icon svg-icon-md svg-icon-primary"><!--begin::Svg Icon | path:assets/media/svg/icons/General/Settings-1.svg--><svg
                                                        xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <a href="#" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
                                                <span
                                                    class="svg-icon svg-icon-md svg-icon-primary"><!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Write.svg--><svg
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                                        height="24px" viewBox="0 0 24 24" version="1.1">
                                                        <g stroke="none" stroke-width="1" fill="none"
                                    ...
                                    <tr>
                                        <td class="pl-0 py-4">
                                            <div class="symbol symbol-50 symbol-light">
                                                <span class="symbol-label">
                                                    <img src="assets/media/svg/misc/015-telegram.sv"
                                                        class="h-50 align-self-center" alt="" />
                                                </span>
                                            </div>
                                        </td>
                                        <td class="pl-0">
                                            <a href="#"
                                                class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Midwifery
                                                Week</a>
                                            <div>
                                                <span class="font-weight-bolder">Institute of Psychology</span>
                                    ...
                                    <tr>
                                        <td class="pl-0 py-4">
                                            <div class="symbol symbol-50 symbol-light">
                                                <span class="symbol-label">
                                                    <img src="assets/media/svg/misc/003-puzzle.sv"
                                                        class="h-50 align-self-center" alt="" />
                                                </span>
                                            </div>
                                        </td>
                                        <td class="pl-0">
                                            <a href="#"
                                                class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">IoE
                                                Week</a>
                                            <div>
                                                <span class="font-weight-bolder">Institute of Engineering</span>
                                                <a class="text-muted font-weight-bold text-hover-primary" href="#"></a>
                                            </div>
                                        </td>
                                        <td class="text-right">
                                    ...
                                    <tr>
                                        <td class="pl-0 py-4">
                                            <div class="symbol symbol-50 symbol-light">
                                                <span class="symbol-label">
                                                    <img src="assets/media/svg/misc/005-bebo.sv"
                                                        class="h-50 align-self-center" alt="" />
                                                </span>
                                            </div>
                                        </td>
                                        <td class="pl-0">
                                            <a href="#"
                                                class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">KLD
                                                Barrio Fiesta</a>
                                            <div>
                                                <span class="font-weight-bolder">KLD - SSC: </span>
                                                <a class="text-muted font-weight-bold text-hover-primary"
                                                    href="#">Camille</a>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="pl-0">
                                            <a href="#"
                                                class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Drug
                                                Awareness Seminar</a>
                                            <div>
                                                <span class="font-weight-bolder">KID </span>
                                                <a class="text-muted font-weight-bold text-hover-primary" href="#">-
                                                    Kabataan Iwas Droga</a>
                                            </div>
                                        </td>
                                        <td class="text-right">
                                            <span class="text-dark-75 font-weight-bolder d-block font-size-lg">
            ...
            <div class="col-lg-6 col-xxl-4 order-1 order-xxl-1">
                ...
                <div class="card card-custom card-stretch gutter-b">
                    ...
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label font-weight-bolder text-dark">Event Categories</span>
                                    ...
                                    <ul class="navi navi-hover py-5">
                                        <li class="navi-item">
                                            <a href="#" class="navi-link">
                                                ...
                                                <span class="navi-text">Add Category</span>
                                            </a>
                                        </li>
                                        <li class="navi-item">
                                            <a href="#" class="navi-link">
                    ...
                    <div class="card-body pt-8">
                        ...
                        <div class="d-flex align-items-center mb-10">
                            ...
                            <div class="d-flex flex-column font-weight-bold">
                                <a href="#" class="text-dark text-hover-primary mb-1 font-size-lg">Academic</a>
                        ...
                        <div class="d-flex align-items-center mb-10">
                            ...
                            <!--begin::Text-->
                            <div class="d-flex flex-column font-weight-bold">
                                <a href="#" class="text-dark-75 text-hover-primary mb-1 font-size-lg">Seminar and
                                    Training</a>
                                <span class="text-muted"></span>
                            </div>
                            <!--end::Text-->
                        ...
                        <div class="d-flex align-items-center mb-10">
                            ...
                            <div class="symbol symbol-40 symbol-light-success mr-5">
                                <span class="symbol-label">
                                    <span
                                        class="svg-icon svg-icon-lg svg-icon-success"><!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Group-chat.svg--><svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                            viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            ...
                            <!--begin::Text-->
                            <div class="d-flex flex-column font-weight-bold">
                                <a href="#" class="text-dark text-hover-primary mb-1 font-size-lg">Celebrations</a>
                                <span class="text-muted"></span>
                            </div>
                            <!--end::Text-->
                        </div>
                        ...
                        <div class="d-flex align-items-center mb-10">
                            ...
                            <div class="symbol symbol-40 symbol-light-danger mr-5">
                                <span class="symbol-label">
                                    <span
                                        class="svg-icon svg-icon-lg svg-icon-danger"><!--begin::Svg Icon | path:assets/media/svg/icons/General/Attachment2.svg--><svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                            viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            ...
                            <!--begin::Text-->
                            <div class="d-flex flex-column font-weight-bold">
                                <a href="#" class="text-dark text-hover-primary mb-1 font-size-lg">Sports</a>
                                <span class="text-muted"></span>
                            </div>
                            <!--end::Text-->
                        </div>
                        ...
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <div class="symbol symbol-40 symbol-light-info mr-5">
                                <span class="symbol-label">
                                    <span
                                        class="svg-icon svg-icon-lg  svg-icon-info"><!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Shield-user.svg--><svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                            viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            ...
                            <!--begin::Text-->
                            <div class="d-flex flex-column font-weight-bold">
                                <a href="#" class="text-dark text-hover-primary mb-1 font-size-lg">Cultural</a>
                                <span class="text-muted"></span>
                            </div>
                            <!--end::Text-->
                        </div>
            ...
            <div class="col-lg-6 col-xxl-4 order-1 order-xxl-2">
                ...
                <div class="card card-custom card-stretch gutter-b">
                    ...
                    <div class="card-header border-0">
                        <h3 class="card-title font-weight-bolder text-dark">Organizers</h3>
                        <div class="card-toolbar">
                                    ...
                                    <ul class="navi navi-hover">
                                        ...
                                        <li class="navi-item">
                                            <a href="#" class="navi-link">
                                                ...
                                                <span class="navi-text">View All</span>
                                            </a>
                                        </li>
                                        <li class="navi-item">
                                            <a href="#" class="navi-link">
                                                <span class="navi-icon"><i class="flaticon2-calendar-8"></i></span>
                                                <span class="navi-text">Add Organizer</span>
                                            </a>
                                        </li>
                                        <li class="navi-item">
                                            <a href="#" class="navi-link">
                    ...
                    <div class="card-body pt-2">
                        ...
                        <div class="d-flex align-items-center mb-10">
                            ...
                            <div class="d-flex flex-column flex-grow-1 font-weight-bold">
                                <a href="#" class="text-dark text-hover-primary mb-1 font-size-lg">Institute of
                                    Information and Computing Science</a>
                                <span class="text-muted">Keno A. Villavicencio</span>
                            </div>
                            <!--end::Text-->
                                ...
                                <div class="dropdown-menu p-0 m-0 dropdown-menu-md dropdown-menu-right">
                                    ...
                                    <ul class="navi navi-hover py-5">
                                        <li class="navi-item">
                                            <a href="#" class="navi-link">
                                                <span class="navi-icon"><i class="flaticon2-drop"></i></span>
                                                <span class="navi-text">View Events</span>
                                            </a>
                                        </li>
                                        <li class="navi-item">
                                            <a href="#" class="navi-link">
                        ...
                        <div class="d-flex align-items-center mb-10">
                            ...
                            <!--begin::Text-->
                            <div class="d-flex flex-column flex-grow-1 font-weight-bold">
                                <a href="#" class="text-dark text-hover-primary mb-1 font-size-lg">KLD Sports & Wellness
                                    Development</a>
                                <span class="text-muted"></span>
                            </div>
                            <!--end::Text-->
                        ...
                        <div class="d-flex align-items-center mb-10">
                            ...
                            <!--begin::Text-->
                            <div class="d-flex flex-column flex-grow-1 font-weight-bold">
                                <a href="#" class="text-dark text-hover-primary mb-1 font-size-lg">KLD - Institute of
                                    Psychology</a>
                                <span class="text-muted"></span>
                            </div>
                            <!--end::Text-->
            ...
            <div class="col-lg-6 col-xxl-4 order-1 order-xxl-2">
                ...
                <div class="card card-custom card-stretch gutter-b">
                    <!--begin::Header-->
                    <div class="card-header border-0">
                        <h3 class="card-title font-weight-bolder text-dark">Degree Programs</h3>
                        <div class="card-toolbar">
                            <div class="dropdown dropdown-inline">
                                <a href="#" class="btn btn-light-primary btn-sm font-weight-bolder dropdown-toggle"
                                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <div class="dropdown-menu p-0 m-0 dropdown-menu-md dropdown-menu-right">
                                    ...
                                    <ul class="navi navi-hover py-5">
                                        ...
                                        <li class="navi-item">
                                            <a href="#" class="navi-link">
                                                <span class="navi-icon"><i class="flaticon2-rocket-1"></i></span>
                                                <span class="navi-text">View Program</span>
                                                <span class="navi-link-badge">
                                                </span>
                                            </a>
                                        </li>
                                        <li class="navi-item">
                                            <a href="#" class="navi-link">
                                                <span class="navi-icon"><i class="flaticon2-list-3"></i></span>
                                                <span class="navi-text">Edit Program</span>
                                            </a>
                                        </li>
