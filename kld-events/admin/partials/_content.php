	...
	<div class=" container ">
		...
		<div class="row">
			<div class="col-xl-4">
				...
				<a href="?page=upcoming-events" class="card card-custom bg-primary bg-hover-state-primary card-stretch gutter-b">
					...
					<div class="card-body">
						...
						<div class="font-weight-bold text-inverse-primary font-size-sm">25</div>
					</div>
					<!--end::Body-->
				</a>
				<!--end::Stats Widget 13-->
			...
			<div class="col-xl-4">
				...
				<a href="?page=proposal-events" class="card card-custom bg-warning bg-hover-state-warning card-stretch gutter-b">
					<!--begin::Body-->
					<div class="card-body">
						<span class="svg-icon svg-icon-white svg-icon-3x ml-n1">
