...
if (isset($_GET['id'])) {
    ...
    $query = "
        SELECT 
            ...
            admin_acc.admin_kld_email,
            admin_acc.admin_kld_id,  
            admin_acc.admin_profilepic, 
            admin_acc.admin_uname,
        ...
        FROM 
            admin_acc
        JOIN 
            course_tbl ON admin_acc.course_id = course_tbl.course_id 
        JOIN 
            section_tbl ON admin_acc.section_id = section_tbl.section_id
        JOIN 
            yearlvl_tbl ON admin_acc.yearlvl = yearlvl_tbl.yearlvl_id
        WHERE 
            admin_acc.admin_id = ?
    ";
    ...
    if ($result->num_rows > 0) {
        ...
        $profilePic = $row['admin_profilepic'];
                    ...
                    <div class="card-body pt-4">
                        ...
                        <div class="py-9">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                ...
                                <a href="#" class="text-muted text-hover-primary"><?php echo $row['admin_kld_email']; ?></a>
                            </div>
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                <span class="font-weight-bold mr-2">KLD-ID:</span>
                                <span class="text-muted"><?php echo $row['admin_kld_id']; ?></span>
                            </div>
                                ...
                                <div class="col-lg-9 col-xl-6">
                                    <div class="input-group input-group-lg input-group-solid">
                                        ...
                                        <input type="text" class="form-control form-control-lg form-control-solid"
                                            value="<?php echo strtok($row['admin_kld_email'], '@'); ?>" disabled placeholder="Email" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-6">
                                    <div class="input-group input-group-lg input-group-solid">
                                        ...
                                        <input type="text" class="form-control form-control-lg form-control-solid"
                                            value="<?php echo $row['admin_kld_id']; ?>" disabled placeholder="ID Number" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
