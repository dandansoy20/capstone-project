				...
				<div class="card card-custom card-stretch gutter-b">
					<div class="card-body d-flex p-0">
						<div class="flex-grow-1 p-8 card-rounded bgi-no-repeat d-flex"
							style="background-color: #FFF; background-position: center bottom; background-size: auto 100%;">
							...
							<div class="row">
								...
								<div class="col-12 col-md-9">
									...
									<a href="?page=attendance-event" class="btn btn-light-danger font-weight-bold py-2 px-6">Archive</a>
								</div>
										...
										<div class="card-header border-0 pt-5">
											<div class="card-title font-weight-bolder">
												<div class="card-label">Attendance
													<div class="font-size-sm text-muted mt-2">321 Attended the event</div>
												</div>
											</div>
										...
										<div class="card-header border-0 pt-5">
											<div class="card-title">
												<div class="card-label">
													...
													<div class="font-size-sm text-muted mt-2">53 Evaluated</div>
												</div>
											</div>
										</div>
										<!--end::Header-->
