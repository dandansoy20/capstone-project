							...
							<div class="row">
								...
								<div class="col-12 col-md-9">
									...
									<form method="post">
										...
										<button id="archive-event" name="archive-event" type="button" class="btn btn-light-danger font-weight-bold py-2">Archive</button>
							...
							<div class="row">
								<?php foreach ($stakeholders as $stakeholder):
									...
									if ($stakeholder['status'] === 'approved') {
										...
										$statusClass = 'text-danger';  // Red for rejected
									} else {
