						...
						<div class="flex-grow-1 p-8 card-rounded bgi-no-repeat d-flex"
							...
							<div class="row">
								...
								<div class="col-12 col-md-9">
									...
									<a href="?page=attendance-event" class="btn btn-light-primary font-weight-bold py-2 px-6">View Attendance</a>
								</div>
				...
				<div class="card card-custom card-stretch gutter-b">
					...
					<div class="card-body d-flex align-items-center py-0 mt-5">
						<div class="d-flex flex-column flex-grow-1 py-2 py-lg-5">
							<a href="#"
								class="card-title font-weight-bolder text-dark-75 font-size-h5 mb-1 text-hover-primary" data-toggle="tooltip" data-theme="dark" title="View Comment" data-toggle="tooltip" data-theme="dark" title="View Comment">Con
								Marvin Serrano</a>
			...
			<div class="col-xl-4">
				...
				<div class="card card-custom card-stretch gutter-b">
					...
					<div class="card-body d-flex align-items-center py-0 mt-5">
						<div class="d-flex flex-column flex-grow-1 py-2 py-lg-5">
							<a href="#"
								class="card-title font-weight-bolder text-dark-75 font-size-h5 mb-1 text-hover-primary" data-toggle="tooltip" data-theme="dark" title="View Comment">Keno
								A. Villavicencio</a>
			...
			<div class="col-xl-4">
				...
				<div class="card card-custom card-stretch gutter-b">
					...
					<div class="card-body d-flex align-items-center py-0 mt-5">
						<div class="d-flex flex-column flex-grow-1 py-2 py-lg-5">
							<a href="#"
								class="card-title font-weight-bolder text-dark-75 font-size-h5 mb-1 text-hover-primary" data-toggle="tooltip" data-theme="dark" title="View Comment">Emmanuel Castro</a>
							<span class="font-weight-bold text-muted  font-size-lg">KLD - Supreme Student Council</span>

							<div class="font-weight-bold text-success mb-3">Approved</div>
						</div>
						<img src="assets/media/ssc.jpg" alt="" class="h-100px" />
					</div>
					<!--end::Body-->
				</div>
				<!--end::Stats Widget 4-->
			...
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
					...
					<div class="modal-body text-center">
						<img src="assets/media/acquaintance/3.jpg" class="img-fluid" alt="Full Preview">
					</div>
				</div>
			</div>
		</div>
			...
			<div class="col-xl-6">
				...
				<div class="card card-custom card-stretch gutter-b">
					...
					<div class="card-header border-0">
						<h3 class="card-title font-weight-bolder text-dark">Attendees</h3>
					...
					<div class="card-body pt-0">
						...
						<div class="d-flex align-items-center mb-9 bg-light-warning rounded p-5">
							...
							<div class="d-flex flex-column flex-grow-1 mr-2">
								<a href="#" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">BS Information Systems</a>
								<span class="text-muted font-weight-bold">All Year Levels</span>
							</div>
							<!--end::Title-->
							<!--begin::Lable-->
						...
						<div class="d-flex align-items-center bg-light-success rounded p-5 mb-9">
							...
							<!--begin::Title-->
							<div class="d-flex flex-column flex-grow-1 mr-2">
								<a href="#" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">BS Midwifery</a>
								<span class="text-muted font-weight-bold">All Year Levels</span>
							</div>
							<!--end::Title-->
							<!--begin::Lable-->
						...
						<div class="d-flex align-items-center bg-light-danger rounded p-5 mb-9">
							...
							<!--begin::Title-->
							<div class="d-flex flex-column flex-grow-1 mr-2">
								<a href="#" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">BS Civil Engineering</a>
								<span class="text-muted font-weight-bold">All Year Levels</span>
							</div>
							<!--end::Title-->
							<!--begin::Lable-->
						...
						<div class="d-flex align-items-center bg-light-info rounded p-5">
							...
							<!--begin::Title-->
							<div class="d-flex flex-column flex-grow-1 mr-2">
								<a href="#" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">BS Nursing</a>
								<span class="text-muted font-weight-bold">3rd Year Only</span>
							</div>
							<!--end::Title-->
							<!--begin::Lable-->
