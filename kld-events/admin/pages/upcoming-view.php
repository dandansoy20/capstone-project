							...
							<div class="row">
								...
								<div class="col-12 col-md-9">
									<a href="#" class="d-flex align-items-center">
										...
										<div class="pl-4">
											<span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Communication/Write.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
									...
									<div class="d-flex my-5">
										...
										<span
											...
											class="text-dark h4 text-hover-primary ">College Building 1: Gym</span>
									</div>
									...
									<a href="?page=memo" class="btn btn-light-danger font-weight-bold py-2 px-6">Archive</a>
								</div>
							...
							<div class="row">
								...
								<div class="col-xl-4">
									<div class="card card-custom card-stretch gutter-b">
										<div class="card-body d-flex align-items-center py-0 mt-5">
											<div class="d-flex flex-column flex-grow-1 py-2 py-lg-5">
												<a href="#" class="card-title font-weight-bolder text-dark-75 font-size-h5 mb-1 text-hover-primary" data-toggle="tooltip" data-theme="dark" title="View Comment">Emmanuel Castro</a>
								...
								<div class="col-xl-4">
									<div class="card card-custom card-stretch gutter-b">
										<div class="card-body d-flex align-items-center py-0 mt-5">
											<div class="d-flex flex-column flex-grow-1 py-2 py-lg-5">
												<a href="#" class="card-title font-weight-bolder text-dark-75 font-size-h5 mb-1 text-hover-primary" data-toggle="tooltip" data-theme="dark" title="View Comment">Cha Ladisla</a>
									...
									<div class="card card-custom gutter-b">
										...
										<div class="card-body">
											...
											<div class="d-flex align-items-center">
												...
												<!--end::Symbol-->
												<!--begin::Description-->
												<span class="text-muted font-weight-bold font-size-lg">What’s on your mind, Mark?</span>
												<!--end::Description-->
											</div>
											<!--end::Top-->
											<!--begin::Form-->
														...
														<ul class="navi navi-hover">
															...
															<li class="navi-item">
																<a href="#" class="navi-link">
																	...
																	<span class="navi-text">Check</span>
																</a>
															</li>
															<li class="navi-item">
																<a href="#" class="navi-link">
																	...
																	<span class="navi-text">Uncheck</span>
																</a>
															</li>
														</ul>
														<!--end::Navigation-->
