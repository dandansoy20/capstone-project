...
<div class="d-flex flex-column-fluid">
	...
	<div class=" container ">
						...
						<div class="flex-grow-1 p-8 card-rounded bgi-no-repeat d-flex"
							...
							<div class="row">
								...
								<div class="col-12 col-md-9">
									...
									<a href="?page=completed-view" class="btn btn-light-primary font-weight-bold py-2 px-6">Back</a>
								</div>
		...
		<div class="alert alert-custom alert-white alert-shadow fade show gutter-b justify-content-center" role="alert">
			...
			<h4 class="text text-center">Overall Experience
			</h4>
		...
		<div class="row">
				...
				<div class="card card-custom gutter-b">
					<div class="card-header">
						<div class="card-title">
							<h3 class="card-label">I was satisfied with my overall experience at the event. </h3>
						</div>
					</div>
					<div class="card-body">
						<!--begin::Chart-->
			...
			<div class="col-lg-4">
				...
				<div class="card card-custom gutter-b">
					<div class="card-header">
						<div class="card-title">
							<h3 class="card-label">The event met my expectations. </h3>
						</div>
					</div>
					<div class="card-body">
						<!--begin::Chart-->
						<div id="chart_112" class="d-flex justify-content-center"></div>
						<!--end::Chart-->
					</div>
				</div>
				<!--end::Card-->
			...
			<div class="col-lg-4">
				...
				<div class="card card-custom gutter-b">
					<div class="card-header">
						<div class="card-title">
							<h3 class="card-label">I would attend a similar event in the future. </h3>
						</div>
					</div>
					<div class="card-body">
						<!--begin::Chart-->
						<div id="chart_212" class="d-flex justify-content-center"></div>
						<!--end::Chart-->
					</div>
				</div>
				<!--end::Card-->
