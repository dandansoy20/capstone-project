					...
					<div class="card card-custom bgi-no-repeat card-stretch gutter-b" style="background-position: right top; background-size: 30% auto; background-image: url(assets/media/svg/shapes/abstract-3.svg)">
						...
						<div class="card-body my-4">
							...
							<div class="font-weight-bold text-muted font-size-sm">
								...
								$row = $result->fetch_row();
								?>
								<span class="text-dark-75 font-weight-bolder font-size-h2 mr-2"><?php echo $row[0] ?></span>Avarage
							</div>
							<div class="progress progress-xs mt-7 bg-primary-o-60">
								<div class="progress-bar bg-primary" role="progressbar" style="width: <?php echo $row[0] ?>%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
							</div>
						</div>
						<!--end::Body-->
					</div>
