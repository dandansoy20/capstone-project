                ...
                <div class="card card-custom card-stretch gutter-b">
                    <div class="card-body d-flex p-0">
                        <div class="flex-grow-1 p-12 card-rounded bgi-no-repeat d-flex flex-column justify-content-center align-items-start"
                            ...
                            <div class="row">
                                <div class="col-9">
                                    <a href="?page=event-view">
                                        <h1 class="text-primary font-weight-bolder m-0 text-hover-secondary">Foundation Week 2024
                                        </h1>
                                    </a>
                                    ...
                                    <div class="d-flex my-5">
                                        <span
                                            ...
                                            </svg></span> <span class="text-dark h4 text-hover-primary">Celebrations</span>
                                        ...
                                        <a href="#">
                                            <span
                                                ...
                                                class="text-dark h4 text-hover-primary ">KLD Grounds</span></a>
                                    </div>
