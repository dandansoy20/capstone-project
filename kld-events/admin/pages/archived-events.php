    ...
    <div class=" container ">
        ...
        $try = mysqli_query(
            ...
            "SELECT DISTINCT
             ...
             WHERE (kld_event.status = 'archived' OR kld_event.status = 'cancelled') AND stakeholder_tbl.admin_id = $adminId
        ...
        while ($row = $try->fetch_array()) {
                             ...
                             <div class="flex-grow-1 p-12 card-rounded bgi-no-repeat d-flex flex-column justify-content-center align-items-start"
                                  ...
                                  <div class="row">
                                     <div class="col-9">
                                         ...
                                         <a href="?page=archived-view&event_id=' . $row["event_id"] . '">
                                             <div class="d-flex align-items-center">
                                                 <h1 class="text-primary font-weight-bolder m-0 text-hover-secondary">' . $row["event_title"] . '</h1>
                                                 <span class="label label-danger label-inline ml-2">' . strtoupper($row["status"]) . '</span>
                                             </div>
                                         </a>
            ...
            ?><?php
                echo '
                         ...
                         <a href="?page=archived-view&event_id=' . $row["event_id"] . '" class="btn btn-primary font-weight-bold py-2 px-6">View Event</a>
                         </div>
                         <div class="col-3">
