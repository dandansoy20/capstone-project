		...
		<div class=" container ">
				...
				<div class="col-xl-3">
					...
					<div class="card card-custom bg-success card-stretch gutter-b">
						...
						<div class="card-body">
							...
							<?php
							$query = "SELECT COUNT(*) FROM std_acc";
				...
				<div class="col-xl-3">
					...
					<div class="card card-custom bg-info card-stretch gutter-b">
						...
						<div class="card-body">
							...
							<?php
							$query = "SELECT COUNT(*) FROM course_tbl";
							$result = $conn->query($query);
							...
							<span class="font-weight-bold text-white font-size-sm">KLD Programs</span>
						</div>
						<!--end::Body-->
					</div>
					<!--end::Stats Widget 31-->
				...
				<div class="col-xl-3">
					...
					<div class="card card-custom bg-primary card-stretch gutter-b">
						...
						<div class="card-body">
							...
							<?php
							$query = "SELECT COUNT(*) FROM section_tbl";
							$result = $conn->query($query);
							$sections = $result->fetch_row();
							?>
							<span class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 d-block"><?php echo $sections[0] ?></span>
							<span class="font-weight-bold text-white font-size-sm">Sections</span>
						</div>
						<!--end::Body-->
					</div>
					<!--end::Stats Widget 31-->
			...
			<div class="card card-custom gutter-b">
				...
				<div class="card-body">
					...
					<!--begin: Datatable-->
					<div class="datatable datatable-bordered datatable-head-custom" id="my_kt_datatable"></div>
					<!--end: Datatable-->
				</div>
			</div>
