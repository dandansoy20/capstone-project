									...
									<div class="col-xl-6">
										...
										<div class="card card-custom bgi-no-repeat card-stretch gutter-b" style="background-position: right top; background-size: 30% auto; background-image: url(assets/media/svg/shapes/abstract-3.svg)">
											...
											<div class="card-body my-4">
												...
												<span class="text-dark-75 font-weight-bolder font-size-h2 mr-2">76%</span>Avarage</div>
														...
														<td class="pr-0">
															<div class="symbol symbol-50 symbol-light mt-1">
																<span class="symbol-label">
																	<img src="assets/jeff.jpg" class="h-75 align-self-end" alt="" />
																</span>
															</div>
														</td>
														<td class="pl-0">
															<a href="#" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Jefferson Montemayor</a>
															<span class="text-muted font-weight-bold text-muted d-block">KLD-21-000123</span>
														</td>
														<td>
															<span class="text-muted font-weight-bold">jmontemayor@kld.edu.ph</span>
														</td>
														<td>
															<span class="text-dark-75 font-weight-bolder d-block font-size-lg">BSIS</span>
															<span class="text-muted font-weight-bold">4th Year</span>
														</td>
                                                        <td>
															<span class="text-dark-75 font-weight-bolder d-block font-size-lg">BSIS 405</span>
														</td>
														<td>
            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap py-5">
                    <div class="card-title">
                        <h3 class="card-label">
                            Student Users
                            <span class="d-block text-muted pt-2 font-size-sm">KLD Student Table</span>
                        </h3>
                    </div>
                    <div class="card-toolbar">
                        <!--begin::Dropdown-->
                        ...
                        <!--begin::Button-->
                        <a href="?page=add-std" class="btn btn-primary font-weight-bolder">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-separate table-head-custom table-checkable" id="kt_datatable">
                        ...
                        <tbody>
                        <?php
                        $try = mysqli_query($conn, "Select * from std_acc");
                        while ($row = $try->fetch_array()) {
                            echo '<tr>';
                            echo '<td>' . $row['std_kld_id'] . '</td>';
