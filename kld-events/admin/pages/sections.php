        ...
        <div class="card card-custom gutter-b">
            ...
            <div class="card-header border-0 py-5">
                ...
                <div class="card-toolbar">
                    <a href="?page=add-section" class="btn btn-info font-weight-bolder font-size-sm">Add Section</a>
                </div>
            </div>
            <!--end::Header-->
                    ...
                    <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
                        <thead>
                            <tr class="text-uppercase">
                                <th class="pl-0" style="min-width: 100px">Section Name</th>
                                <th style="min-width: 120px">Course</th>
                                <th style="min-width: 150px"><span class="text-primary">Year Level</span>
                                    <span
                                        class="svg-icon svg-icon-sm svg-icon-primary"><!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Down-2.svg--><svg
