                    ...
                    <div class="card-body pt-4">
                        ...
                        <div class="py-9">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <span class="text-muted">4th Year</span>
                            </div>
                            <div class="d-flex align-items-center justify-content-between">
                                <span class="font-weight-bold mr-2">Course:</span>
                                <span class="text-muted">BSIS</span>
                            </div>
                        </div>
                        <!--end::Contact-->
                        ...
                        <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                            ...
                            <div class="navi-item mb-2">
                                <a href="?page=cpass-std" class="navi-link py-4 active ">
                                    <span class="navi-icon mr-2">
                                        <span
                        ...
                        <div class="card-body">
                            ...
                            <div class="alert alert-custom alert-light-danger fade show mb-10" role="alert">
                                ...
                                <div class="alert-text font-weight-bold">
                                    Configure user passwords to expire periodically. Users will need warning that their
                                    passwords are going to expire,<br />
