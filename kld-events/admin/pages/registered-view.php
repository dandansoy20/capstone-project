		...
		<div class="card card-custom gutter-b">
			...
			<div class="card-header border-0 py-5">
				<h3 class="card-title align-items-start flex-column">
					<span class="card-label font-weight-bolder text-dark">Event Registration</span>
						...
						<div class="dropdown mr-2">
							...
							<div class="dropdown-menu dropdown-menu-sm">
								<ul class="nav nav-hover flex-column">
									<li class="nav-item"><a href="#" class="nav-link"><span class="nav-text">Registered</span></a></li>
					...
					<table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_1">
						<thead>
							<tr class="text-left">
								...
								<th class="min-width: 150px" style="min-width: 150px">Status</th>
							</tr>
						</thead>
						<tbody>
							<?php
