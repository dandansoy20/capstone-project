            ...
            <div class="overlay-container">
              <div class="overlay">
                <div class="overlay-panel overlay-left">
                  ...
                  <p class="login-p">
                    Enter your ID number and create your usename and password.
                  </p>
                  <button class="ghost" id="signIn">Student</button>
                </div>
                <div class="overlay-panel overlay-right">
                  <h1 style="color: #ffffff">Welcome Regals!</h1>
                  <p class="login-p">
                    To get started, please log in your account.
                  </p>

                  <button class="ghost" href="" id="signUp">Employee</button>
                </div>
              </div>
            </div>
          </div>
