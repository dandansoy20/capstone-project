                    ...
                    <div class="card-body d-flex p-0">
                        <div class="flex-grow-1 p-8 card-rounded bgi-no-repeat d-flex"
                            ...
                            <div class="col-9 col-xl-9">
                                ...
                                <a href="?page=memo"
                                    class="btn btn-primary font-weight-bold py-2 px-6">View Memo</a>
                            </div>
                        </div>
            ...
            <div class="col-xl-4">
                ...
                <div class="card card-custom card-stretch gutter-b">
                    ...
                    <div class="card-body d-flex align-items-center py-0 mt-5">
                        <div class="d-flex flex-column flex-grow-1 py-2 py-lg-5">
                            <a href="#"
                                class="card-title font-weight-bolder text-dark-75 font-size-h5 mb-1 text-hover-primary">Riza Mae Alburo</a>
            ...
            <div class="col-xl-4">
                ...
                <div class="card card-custom card-stretch gutter-b">
                    ...
                    <div class="card-body d-flex align-items-center py-0 mt-5">
                        <div class="d-flex flex-column flex-grow-1 py-2 py-lg-5">
                            <a href="#"
                                class="card-title font-weight-bolder text-dark-75 font-size-h5 mb-1 text-hover-primary">Keno A. Villavicencio</a>
