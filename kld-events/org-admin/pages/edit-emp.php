...
if (isset($_GET['id'])) {
    ...
    // Prepare the SQL query to fetch the employee's data based on the provided ID
    $query = "
        SELECT 
            emp_acc.*,
            org_tbl.org_name
    ...
    if ($result->num_rows > 0) {
        ...
        $fullName = $row['emp_fname'] . ' ' . $row['emp_lname'];
        $org = $row['org_name'];
        $profilePic = $row['emp_profilepic'];
    } else {
        echo "No record found for this employee.";
    }
                    ...
                    <div class="card-body pt-4">
                        ...
                        <div class="py-9">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                ...
                                <a href="#" class="text-muted text-hover-primary"><?php echo $row['emp_kld_email']; ?></a>
                            </div>
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                <span class="font-weight-bold mr-2">KLD-ID:</span>
                                <span class="text-muted"><?php echo $row['emp_kld_id']; ?></span>
                            </div>
                        ...
                        <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                            ...
                            <div class="navi-item mb-2">
                                <a href="?page=overview-emp" class="navi-link py-4">
                            ...
                            <div class="navi-item mb-2">
                                <a href="?page=cpass-emp" class="navi-link py-4 ">
                                    <span class="navi-icon mr-2">
                                        <span
                                ...
                                <div class="col-lg-9 col-xl-6">
                                    <div class="input-group input-group-lg input-group-solid">
                                        ...
                                        <input type="text" class="form-control form-control-lg form-control-solid"
                                            value="<?php echo strtok($row['emp_kld_email'], '@'); ?>" disabled placeholder="Email" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-6">
                                    <div class="input-group input-group-lg input-group-solid">
                                        ...
                                        <input type="text" class="form-control form-control-lg form-control-solid"
                                            value="<?php echo $row['emp_kld_id']; ?>" disabled placeholder="ID Number" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
