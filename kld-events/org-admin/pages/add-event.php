                ...
                <div class="wizard wizard-1" id="kt_wizard_v1" data-wizard-state="step-first"
                    ...
                    <div class="wizard-nav border-bottom">
                        <div class="wizard-steps p-8 p-lg-10">
                            ...
                            <div class="wizard-step" data-wizard-type="step">
                                <div class="wizard-label">
                                    <i class="wizard-icon flaticon-interface-11"></i>
                                    <h3 class="wizard-title">4. Proposal Letter</h3>
                                </div>
                                <span
                                    class="svg-icon svg-icon-xl wizard-arrow"><!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Arrow-right.svg--><svg
                                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                ...
                                <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="delivery" class="form-control form-control-solid form-control-lg">
                                            ...
                                            <option value="cb1" selected>College Building 1
                                            </option>
                                            <option value="kld-og">KLD Open Grounds</option>
                                        </select>
                                    </div>
                                ...
                                <div class="pb-5" data-wizard-type="step-content">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-solid form-control-lg"
                                            name="title" placeholder="Event Details" value="" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="cateegory"
                                            class="form-control form-control-solid form-control-lg">
                                            <option value="">Select category</option>
                                            <option value="cb1" selected>Academic
                                            </option>
                                            <option value="kld-og">Sports</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="organizer"
                                            ...
                                            <option value="">KLD - ISACEC</option>
                                            <option value="">Institute of Information and Computing Science</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <span class="switch switch-icon">
                                                <label>
                                                    <input type="checkbox" checked="checked" name="selectAll" />
                                                    <span></span>
                                                </label>
                                            </span>
                                        </div>
