...
if (!array_key_exists('ajax', $_GET)) {
    ...
    exit(); // Ensures that the script stops running after the redirect
    ...
    if ($_GET['ajax'] == "account_activation") {
        ...
        $_SESSION['kld_email'] = "";
        $try = mysqli_query($conn, "Select * from org_acc where org_activation_key = '" . $_SESSION['activation_key'] . "'");
        while ($row = $try->fetch_array()) {
            echo "";
            $_SESSION['kld_id'] = $row['org_kld_id'];
...
-->
        ...
        <head>
            <base href="">
            <meta charset="utf-8" />
            <title> KLD Events | Sign Up</title>
        ...
        <body id="kt_body"
                    ...
                    <div class="d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid"
                        ...
                        <div class="login-form text-center text-white p-7 position-relative overflow-hidden">
                            ...
                            <div class="d-flex flex-center mb-15">
                                <a href="index.php">
                                    <img src="assets/media/logos/kldlogo.png" class="max-h-75px" alt="" />
                                </a>
                            </div>
                            ...
                            <div class="login-signin">
                                ...
                                <form class="form text-center" id="kt_login_signup_form">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <input
                                                    class="form-control h-auto text-white bg-white-o-5 rounded-pill border-0 py-4 px-8"
                                                    type="" placeholder="First Name" id="kld_signup_fname" disabled value="<?php echo $_SESSION['kld_fname'] ?>" />
                                            </div>
                                            <div class="col-6">

                                                <input
                                                    class="form-control h-auto text-white bg-white-o-5 rounded-pill border-0 py-4 px-8"
                                                    type="" placeholder="Last Name" id="kld_signup_lname" disabled value="<?php echo $_SESSION['kld_lname'] ?>" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <input
                                            class="form-control h-auto text-white bg-white-o-5 rounded-pill border-0 py-4 px-8"
                                            type="text" placeholder="Username" id="kld_username" />
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <button type="button" onclick="window.location.href='index.php';" class="btn btn-pill btn-outline-white opacity-70 px-15 py-3 m-2">Cancel</button>
            ...
            <script src="control/js/signup.js"></script>
