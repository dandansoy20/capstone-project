...
if (isset($_GET['event_id']) && isset($_GET['std_id'])) {
            ...
            <div class="flex-md-row-fluid ml-md-6 ml-lg-8">
                <div class="row">
                    <div class="col-xxl-8">
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="collapseTwo5" class="collapse" data-parent="#accordionExample5">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex pt-4">
                                                    <div class="d-flex align-items-center pr-5">
                                                        <span class="text-dark-50 font-size-lg font-weight-bold pr-1">KLD ID:</span> <span class="text-dark font-size-lg font-weight-bold"><?php echo $_SESSION['kld_std_id'] ?></span>
                                                    </div>
                                                </div>
                                                <div class="d-flex pt-4">
                                                    <div class="d-flex align-items-center pr-5">
                                                        <span class="text-dark-50 font-size-lg font-weight-bold pr-1">Program:</span> <span class="text-dark font-size-lg font-weight-bold"><?php echo $_SESSION['kld_program'] ?></span>
                                                    </div>
                                                </div>
                                                <div class="d-flex pt-4">
                                                    <div class="d-flex align-items-center pr-5">
                                                        <span class="text-dark-50 font-size-lg font-weight-bold pr-1">Year Level:</span> <span class="text-dark font-size-lg font-weight-bold"><?php echo $_SESSION['kld_yearlvl'] ?></span>
                                                    </div>
                                                </div>
                                                <div class="d-flex pt-4">
                                                    <div class="d-flex align-items-center pr-5">
                                                        <span class="text-dark-50 font-size-lg font-weight-bold pr-1">Section:</span> <span class="text-dark font-size-lg font-weight-bold"><?php echo $_SESSION['kld_section'] ?></span>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="checkbox-list">
                                            <label class="checkbox">
                                                <input type="checkbox" name="agree" id="agree" data-gtm-form-interact-field-id="1">
                                                <span></span>
                        ...
                        <!-- Feedback Forms -->
                        <div id="feedback-forms" class="d-none">
                            ...
                            <div class="text-center pb-7 pb-xxl-1 mb-10">
                                <div class="form-group">
                                    ...
                                    <button class="btn btn-light-primary font-weight-bolder font-size-sm py-3 px-9" id="submit_feedback" type="submit" name="submit_feedback">Submit</button>
                                </div>
                            </div>
