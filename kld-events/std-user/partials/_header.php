...
<div id="kt_header" class="header header-fixed">
	...
	<div class="container">
		...
		<div class="d-none d-lg-flex align-items-center mr-3">
			<!--begin::Logo-->
			<a href="index.php">
				<img alt="Logo" src="assets/media/logos/kldlogo.png" class="logo-default max-h-40px" />
			...
			<div class="dropdown">
				...
				<div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg p-0">
					...
					<div class="navi navi-spacer-x-0 pt-5">
						<!--begin::Item-->
						<a href="custom/apps/user/profile-1/personal-information.php" class="navi-item px-8">
							<div class="navi-link">
								<div class="navi-icon mr-2">
						...
						<!--end::Item-->
						<!--begin::Item-->
						<a href="custom/apps/user/profile-3.php" class="navi-item px-8">
							<div class="navi-link">
								<div class="navi-icon mr-2">
						...
						<!--end::Item-->
						<!--begin::Item-->
						<a href="custom/apps/user/profile-2.php" class="navi-item px-8">
							<div class="navi-link">
								<div class="navi-icon mr-2">
						...
						<!--end::Item-->
						<!--begin::Item-->
						<a href="custom/apps/userprofile-1/overview.php" class="navi-item px-8">
							<div class="navi-link">
								<div class="navi-icon mr-2">
						...
						<div class="navi-footer px-8 py-5">
							<a href="custom/user/login-v2.php" target="_blank" class="btn btn-light-primary font-weight-bold">Sign Out</a>
							<a href="custom/user/login-v2.php" target="_blank" class="btn btn-clean font-weight-bold">Upgrade Plan</a>
						</div>
						<!--end::Footer-->
					</div>
					<!--end::Nav-->
						...
						<ul class="menu-subnav">
							<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
								...
								<div class="menu-submenu menu-submenu-classic menu-submenu-right">
									<ul class="menu-subnav">
										<li class="menu-item" aria-haspopup="true">
											<a href="features/bootstrap/typography.php" class="menu-link">
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/bootstrap/buttons.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/bootstrap/button-group.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/bootstrap/dropdown.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/bootstrap/navs.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/bootstrap/tables.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/bootstrap/progress.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/bootstrap/modal.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/bootstrap/alerts.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/bootstrap/popover.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/bootstrap/tooltip.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
							...
							<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
								...
								<div class="menu-submenu menu-submenu-classic menu-submenu-right">
									<ul class="menu-subnav">
										<li class="menu-item" aria-haspopup="true">
											<a href="features/custom/utilities.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/custom/accordions.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/custom/label.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/custom/pulse.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/custom/line-tabs.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/custom/advance-navs.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/custom/timeline.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/custom/pagination.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/custom/symbol.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/custom/spinners.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/custom/iconbox.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/custom/callout.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/custom/ribbons.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
							...
							<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
								...
								<div class="menu-submenu menu-submenu-classic menu-submenu-right">
									<ul class="menu-subnav">
										<li class="menu-item" aria-haspopup="true">
											<a href="features/icons/flaticon.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/icons/fontawesome5.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/icons/lineawesome.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/icons/socicons.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/icons/svg.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/icons/keenthemes-icons.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
							...
							<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
								...
								<div class="menu-submenu menu-submenu-classic menu-submenu-right">
									<ul class="menu-subnav">
										<li class="menu-item" aria-haspopup="true">
											<a href="features/cards/general.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/cards/stacked.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/cards/tabbed.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/cards/draggable.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/cards/tools.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/cards/sticky.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/cards/stretched.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
							...
							<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
								...
								<div class="menu-submenu menu-submenu-classic menu-submenu-right">
									<ul class="menu-subnav">
										<li class="menu-item" aria-haspopup="true">
											<a href="features/widgets/lists.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/widgets/stats.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/widgets/charts.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/widgets/mixed.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/widgets/feeds.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/widgets/engage.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/widgets/base-tables.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/widgets/advance-tables.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/widgets/nav-panels.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
							...
							<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
								...
								<div class="menu-submenu menu-submenu-classic menu-submenu-right">
									<ul class="menu-subnav">
										<li class="menu-item" aria-haspopup="true">
											<a href="features/calendar/basic.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/calendar/list-view.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/calendar/google.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/calendar/external-events.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/calendar/background-events.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
							...
							<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
								...
								<div class="menu-submenu menu-submenu-classic menu-submenu-right">
									<ul class="menu-subnav">
										<li class="menu-item" aria-haspopup="true">
											<a href="features/charts/apexcharts.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
											...
											<div class="menu-submenu menu-submenu-classic menu-submenu-right">
												<ul class="menu-subnav">
													<li class="menu-item" aria-haspopup="true">
														<a href="features/charts/amcharts/charts.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="features/charts/amcharts/stock-charts.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="features/charts/amcharts/maps.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/charts/flotcharts.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/charts/google-charts.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
							...
							<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
								...
								<div class="menu-submenu menu-submenu-classic menu-submenu-right">
									<ul class="menu-subnav">
										<li class="menu-item" aria-haspopup="true">
											<a href="features/maps/google-maps.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/maps/leaflet.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/maps/jqvmap.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
							...
							<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
								...
								<div class="menu-submenu menu-submenu-classic menu-submenu-right" style="top: -150px">
									<ul class="menu-subnav">
										<li class="menu-item" aria-haspopup="true">
											<a href="features/miscellaneous/kanban-board.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/miscellaneous/sticky-panels.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/miscellaneous/blockui.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/miscellaneous/perfect-scrollbar.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/miscellaneous/treeview.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/miscellaneous/bootstrap-notify.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/miscellaneous/toastr.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/miscellaneous/sweetalert2.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/miscellaneous/dual-listbox.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/miscellaneous/session-timeout.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/miscellaneous/idle-timer.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="features/miscellaneous/cropper.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
						...
						<ul class="menu-subnav">
									...
									<ul class="menu-subnav">
										<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
											...
											<div class="menu-submenu menu-submenu-classic menu-submenu-right">
												<ul class="menu-subnav">
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/forms/controls/base.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/forms/controls/input-group.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/forms/controls/checkbox.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/forms/controls/radio.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/forms/controls/switch.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/forms/controls/option.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
										...
										<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
											...
											<div class="menu-submenu menu-submenu-classic menu-submenu-right">
												<ul class="menu-subnav">
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/forms/widgets/bootstrap-datetimepicker.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/forms/widgets/bootstrap-datepicker.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/forms/widgets/bootstrap-timepicker.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/forms/widgets/bootstrap-daterangepicker.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/forms/widgets/tagify.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/forms/widgets/bootstrap-touchspin.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/forms/widgets/bootstrap-maxlength.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/forms/widgets/bootstrap-switch.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
															<span class="menu-text">Switch</span>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/forms/widgets/bootstrap-multipleselectsplitter.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/forms/widgets/bootstrap-select.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/forms/widgets/select2.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/forms/widgets/typeahead.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
										...
										<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
											...
											<div class="menu-submenu menu-submenu-classic menu-submenu-right">
												<ul class="menu-subnav">
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/forms/widgets/nouislider.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/forms/widgets/form-repeater.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/forms/widgets/ion-range-slider.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/forms/widgets/input-mask.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/forms/widgets/jquery-mask.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/forms/widgets/autosize.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/forms/widgets/clipboard.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/forms/widgets/recaptcha.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
										...
										<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
											...
											<div class="menu-submenu menu-submenu-classic menu-submenu-right">
												<ul class="menu-subnav">
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/forms/editors/tinymce.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
														...
														<div class="menu-submenu menu-submenu-classic menu-submenu-right">
															<ul class="menu-subnav">
																<li class="menu-item" aria-haspopup="true">
																	<a href="crud/forms/editors/ckeditor-classic.php" class="menu-link">
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="crud/forms/editors/ckeditor-inline.php" class="menu-link">
																		<i class="menu-bullet menu-bullet-line">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="crud/forms/editors/ckeditor-balloon.php" class="menu-link">
																		<i class="menu-bullet menu-bullet-line">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="crud/forms/editors/ckeditor-balloon-block.php" class="menu-link">
																		<i class="menu-bullet menu-bullet-line">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="crud/forms/editors/ckeditor-document.php" class="menu-link">
																		<i class="menu-bullet menu-bullet-line">
																			<span></span>
																		</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/forms/editors/quill.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/forms/editors/summernote.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/forms/editors/bootstrap-markdown.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
										...
										<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
											...
											<div class="menu-submenu menu-submenu-classic menu-submenu-right">
												<ul class="menu-subnav">
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/forms/layouts/default-forms.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/forms/layouts/multi-column-forms.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/forms/layouts/action-bars.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/forms/layouts/sticky-action-bar.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
										...
										<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
											...
											<div class="menu-submenu menu-submenu-classic menu-submenu-right">
												<ul class="menu-subnav">
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/forms/validation/states.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/forms/validation/form-controls.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
															<span class="menu-text">Form Controls</span>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/forms/validation/form-widgets.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
															<span class="menu-text">Form Widgets</span>
									...
									<ul class="menu-subnav">
										<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
											...
											<div class="menu-submenu menu-submenu-classic menu-submenu-right">
												<ul class="menu-subnav">
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/ktdatatable/base/data-local.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/ktdatatable/base/data-json.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/ktdatatable/base/data-ajax.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/ktdatatable/base/html-table.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/ktdatatable/base/local-sort.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/ktdatatable/base/translation.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
										...
										<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
											...
											<div class="menu-submenu menu-submenu-classic menu-submenu-right">
												<ul class="menu-subnav">
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/ktdatatable/advanced/record-selection.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/ktdatatable/advanced/row-details.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/ktdatatable/advanced/modal.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/ktdatatable/advanced/column-rendering.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/ktdatatable/advanced/column-width.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/ktdatatable/advanced/vertical.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
										...
										<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
											...
											<div class="menu-submenu menu-submenu-classic menu-submenu-right">
												<ul class="menu-subnav">
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/ktdatatable/child/data-local.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
															<span class="menu-text">Local Data</span>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/ktdatatable/child/data-ajax.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
										...
										<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
											...
											<div class="menu-submenu menu-submenu-classic menu-submenu-right">
												<ul class="menu-subnav">
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/ktdatatable/api/methods.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/ktdatatable/api/events.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
									...
									<ul class="menu-subnav">
										<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
											...
											<div class="menu-submenu menu-submenu-classic menu-submenu-right">
												<ul class="menu-subnav">
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/datatables/basic/basic.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/datatables/basic/scrollable.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/datatables/basic/headers.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/datatables/basic/paginations.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
										...
										<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
											...
											<div class="menu-submenu menu-submenu-classic menu-submenu-right">
												<ul class="menu-subnav">
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/datatables/advanced/column-rendering.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
															<span class="menu-text">Column Rendering</span>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/datatables/advanced/multiple-controls.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/datatables/advanced/column-visibility.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/datatables/advanced/row-callback.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/datatables/advanced/row-grouping.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/datatables/advanced/footer-callback.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
										...
										<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
											...
											<div class="menu-submenu menu-submenu-classic menu-submenu-right">
												<ul class="menu-subnav">
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/datatables/data-sources/html.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/datatables/data-sources/javascript.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/datatables/data-sources/ajax-client-side.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/datatables/data-sources/ajax-server-side.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
										...
										<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
											...
											<div class="menu-submenu menu-submenu-classic menu-submenu-right">
												<ul class="menu-subnav">
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/datatables/search-options/column-search.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/datatables/search-options/advanced-search.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
										...
										<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
											...
											<div class="menu-submenu menu-submenu-classic menu-submenu-right">
												<ul class="menu-subnav">
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/datatables/extensions/buttons.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
															<span class="menu-text">Buttons</span>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/datatables/extensions/colreorder.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/datatables/extensions/keytable.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/datatables/extensions/responsive.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/datatables/extensions/rowgroup.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/datatables/extensions/rowreorder.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/datatables/extensions/scroller.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="crud/datatables/extensions/select.php" class="menu-link">
															<i class="menu-bullet menu-bullet-dot">
																<span></span>
															</i>
							...
							<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
								...
								<div class="menu-submenu menu-submenu-classic menu-submenu-right">
									<ul class="menu-subnav">
										<li class="menu-item" aria-haspopup="true">
											<a href="crud/file-upload/image-input.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="crud/file-upload/dropzonejs.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="crud/file-upload/uppy.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
						...
						<ul class="menu-subnav">
							<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
								...
								<div class="menu-submenu menu-submenu-classic menu-submenu-right">
									<ul class="menu-subnav">
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/user/list-default.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/user/list-datatable.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/user/list-columns-1.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/user/list-columns-2.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/user/add-user.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/user/edit-user.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
									...
									<ul class="menu-subnav">
										<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
											...
											<div class="menu-submenu menu-submenu-classic menu-submenu-right">
												<ul class="menu-subnav">
													<li class="menu-item" aria-haspopup="true">
														<a href="custom/apps/profile/profile-1/overview.php" class="menu-link">
															<i class="menu-bullet menu-bullet-line">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="custom/apps/profile/profile-1/personal-information.php" class="menu-link">
															<i class="menu-bullet menu-bullet-line">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="custom/apps/profile/profile-1/account-information.php" class="menu-link">
															<i class="menu-bullet menu-bullet-line">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="custom/apps/profile/profile-1/change-password.php" class="menu-link">
															<i class="menu-bullet menu-bullet-line">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="custom/apps/profile/profile-1/email-settings.php" class="menu-link">
															<i class="menu-bullet menu-bullet-line">
																<span></span>
															</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/profile/profile-2.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/profile/profile-3.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/profile/profile-4.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
							...
							<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
								...
								<div class="menu-submenu menu-submenu-classic menu-submenu-right">
									<ul class="menu-subnav">
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/contacts/list-columns.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/contacts/list-datatable.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
												<span class="menu-text">List - Datatable</span>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/contacts/view-contact.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/contacts/add-contact.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/contacts/edit-contact.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
							...
							<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
								...
								<div class="menu-submenu menu-submenu-classic menu-submenu-right">
									<ul class="menu-subnav">
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/chat/private.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/chat/group.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/chat/popup.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
							...
							<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
								...
								<div class="menu-submenu menu-submenu-classic menu-submenu-right">
									<ul class="menu-subnav">
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/projects/list-columns-1.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
												<span class="menu-text">List - Columns 1</span>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/projects/list-columns-2.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
												<span class="menu-text">List - Columns 2</span>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/projects/list-columns-3.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/projects/list-columns-4.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/projects/list-datatable.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
												<span class="menu-text">List - Datatable</span>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/projects/view-project.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/projects/add-project.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/projects/edit-project.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
							...
							<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
								...
								<div class="menu-submenu menu-submenu-classic menu-submenu-right">
									<ul class="menu-subnav">
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/support-center/home-1.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/support-center/home-2.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/support-center/faq-1.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/support-center/faq-2.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/support-center/faq-3.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/support-center/feedback.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/support-center/license.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
							...
							<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
								...
								<div class="menu-submenu menu-submenu-classic menu-submenu-right">
									<ul class="menu-subnav">
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/todo/tasks.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/todo/docs.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/todo/files.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
									...
									<ul class="menu-subnav">
										<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
											...
											<div class="menu-submenu menu-submenu-classic menu-submenu-right">
												<ul class="menu-subnav">
													<li class="menu-item" aria-haspopup="true">
														<a href="custom/apps/education/school/dashboard.php" class="menu-link">
															<i class="menu-bullet menu-bullet-line">
																<span></span>
															</i>
															<span class="menu-text">Dashboard</span>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="custom/apps/education/school/statistics.php" class="menu-link">
															<i class="menu-bullet menu-bullet-line">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="custom/apps/education/school/calendar.php" class="menu-link">
															<i class="menu-bullet menu-bullet-line">
																<span></span>
															</i>
															<span class="menu-text">Calendar</span>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="custom/apps/education/school/library.php" class="menu-link">
															<i class="menu-bullet menu-bullet-line">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="custom/apps/education/school/teachers.php" class="menu-link">
															<i class="menu-bullet menu-bullet-line">
																<span></span>
															</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="custom/apps/education/school/students.php" class="menu-link">
															<i class="menu-bullet menu-bullet-line">
																<span></span>
															</i>
										...
										<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
											...
											<div class="menu-submenu menu-submenu-classic menu-submenu-right">
												<ul class="menu-subnav">
													<li class="menu-item" aria-haspopup="true">
														<a href="custom/apps/education/student/dashboard.php" class="menu-link">
															<i class="menu-bullet menu-bullet-line">
																<span></span>
															</i>
															<span class="menu-text">Dashboard</span>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="custom/apps/education/student/profile.php" class="menu-link">
															<i class="menu-bullet menu-bullet-line">
																<span></span>
															</i>
															<span class="menu-text">Profile</span>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="custom/apps/education/student/calendar.php" class="menu-link">
															<i class="menu-bullet menu-bullet-line">
																<span></span>
															</i>
															<span class="menu-text">Calendar</span>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="custom/apps/education/student/classmates.php" class="menu-link">
															<i class="menu-bullet menu-bullet-line">
																<span></span>
															</i>
										...
										<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
											...
											<div class="menu-submenu menu-submenu-classic menu-submenu-right">
												<ul class="menu-subnav">
													<li class="menu-item" aria-haspopup="true">
														<a href="custom/apps/education/class/dashboard.php" class="menu-link">
															<i class="menu-bullet menu-bullet-line">
																<span></span>
															</i>
															<span class="menu-text">Dashboard</span>
							...
							<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
								...
								<div class="menu-submenu menu-submenu-classic menu-submenu-right">
									<ul class="menu-subnav">
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/ecommerce/dashboard.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/ecommerce/dashboard-2.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/ecommerce/dashboard-3.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/ecommerce/product-1.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/ecommerce/product-2.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/ecommerce/product-3.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/ecommerce/my-orders.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/ecommerce/order-details.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/ecommerce/shopping-cart.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/apps/ecommerce/checkout.php" class="menu-link">
												<i class="menu-bullet menu-bullet-dot">
													<span></span>
												</i>
							...
							<li class="menu-item" aria-haspopup="true">
								<a href="custom/apps/inbox.php" class="menu-link">
									<span class="svg-icon menu-icon">
										<!--begin::Svg Icon | path:assets/media/svg/icons/General/Shield-check.svg-->
										<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
											<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
						...
						<div class="menu-subnav">
							<ul class="menu-content">
								<li class="menu-item">
									...
									<ul class="menu-inner">
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/pages/pricing/pricing-1.php" class="menu-link">
												<i class="menu-bullet menu-bullet-line">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/pages/pricing/pricing-2.php" class="menu-link">
												<i class="menu-bullet menu-bullet-line">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/pages/pricing/pricing-3.php" class="menu-link">
												<i class="menu-bullet menu-bullet-line">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/pages/pricing/pricing-4.php" class="menu-link">
												<i class="menu-bullet menu-bullet-line">
													<span></span>
												</i>
								...
								<li class="menu-item">
									...
									<ul class="menu-inner">
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/pages/wizard/wizard-1.php" class="menu-link">
												<i class="menu-bullet menu-bullet-line">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/pages/wizard/wizard-2.php" class="menu-link">
												<i class="menu-bullet menu-bullet-line">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/pages/wizard/wizard-3.php" class="menu-link">
												<i class="menu-bullet menu-bullet-line">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/pages/wizard/wizard-4.php" class="menu-link">
												<i class="menu-bullet menu-bullet-line">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/pages/wizard/wizard-5.php" class="menu-link">
												<i class="menu-bullet menu-bullet-line">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/pages/wizard/wizard-6.php" class="menu-link">
												<i class="menu-bullet menu-bullet-line">
													<span></span>
												</i>
								...
								<li class="menu-item">
									...
									<ul class="menu-inner">
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/pages/invoices/invoice-1.php" class="menu-link">
												<i class="menu-bullet menu-bullet-line">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/pages/invoices/invoice-2.php" class="menu-link">
												<i class="menu-bullet menu-bullet-line">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/pages/invoices/invoice-3.php" class="menu-link">
												<i class="menu-bullet menu-bullet-line">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/pages/invoices/invoice-4.php" class="menu-link">
												<i class="menu-bullet menu-bullet-line">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/pages/invoices/invoice-5.php" class="menu-link">
												<i class="menu-bullet menu-bullet-line">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/pages/invoices/invoice-6.php" class="menu-link">
												<i class="menu-bullet menu-bullet-line">
													<span></span>
												</i>
								...
								<li class="menu-item">
									...
									<ul class="menu-inner">
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/pages/login/login-1.php" class="menu-link">
												<i class="menu-bullet menu-bullet-line">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/pages/login/login-2.php" class="menu-link">
												<i class="menu-bullet menu-bullet-line">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/pages/login/login-3/signup.php" class="menu-link">
												<i class="menu-bullet menu-bullet-line">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/pages/login/login-4/signup.php" class="menu-link">
												<i class="menu-bullet menu-bullet-line">
													<span></span>
												</i>
								...
								<li class="menu-item">
									...
									<ul class="menu-inner">
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/pages/login/classic/login-1.php" class="menu-link">
												<i class="menu-bullet menu-bullet-line">
													<span></span>
												</i>
												<span class="menu-text">Login 1</span>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/pages/login/classic/login-2.php" class="menu-link">
												<i class="menu-bullet menu-bullet-line">
													<span></span>
												</i>
												<span class="menu-text">Login 2</span>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/pages/login/classic/login-3.php" class="menu-link">
												<i class="menu-bullet menu-bullet-line">
													<span></span>
												</i>
												<span class="menu-text">Login 3</span>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/pages/login/classic/login-4.php" class="menu-link">
												<i class="menu-bullet menu-bullet-line">
													<span></span>
												</i>
												<span class="menu-text">Login 4</span>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/pages/login/classic/login-5.php" class="menu-link">
												<i class="menu-bullet menu-bullet-line">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/pages/login/classic/login-6.php" class="menu-link">
												<i class="menu-bullet menu-bullet-line">
													<span></span>
												</i>
								...
								<li class="menu-item">
									...
									<ul class="menu-inner">
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/pages/error/error-1.php" class="menu-link">
												<i class="menu-bullet menu-bullet-line">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/pages/error/error-2.php" class="menu-link">
												<i class="menu-bullet menu-bullet-line">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/pages/error/error-3.php" class="menu-link">
												<i class="menu-bullet menu-bullet-line">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/pages/error/error-4.php" class="menu-link">
												<i class="menu-bullet menu-bullet-line">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/pages/error/error-5.php" class="menu-link">
												<i class="menu-bullet menu-bullet-line">
													<span></span>
												</i>
										...
										<li class="menu-item" aria-haspopup="true">
											<a href="custom/pages/error/error-6.php" class="menu-link">
												<i class="menu-bullet menu-bullet-line">
													<span></span>
												</i>
