...
var KTLeaflet = (function () {
  ...
  var demo1 = function () {
    ...
    marker
      .bindPopup("<b>Flinder's Station</b><br/>Melbourne, Victoria")
      .openPopup();
  };
  ...
  var demo3 = function () {
    ...
    var marker2 = L.marker([41.804, 13.843], { icon: leafletIcon2 }).addTo(
      leaflet
    );
    var marker3 = L.marker([51.11, 10.371], { icon: leafletIcon3 }).addTo(
      leaflet
    );
    var marker4 = L.marker([46.74, 2.417], { icon: leafletIcon4 }).addTo(
      leaflet
    );
      ...
      geocodeService
        ...
        .run(function (error, result) {
          ...
          L.marker(result.latlng, { icon: leafletIcon })
            ...
            .openPopup();
          alert(
            `You've clicked on the following address: ${result.address.Match_addr}`
          );
        });
    });
  };
  ...
  var demo6 = function () {
    ...
    var data = [
      ...
      { loc: [41.507175, 13.27369], title: "royalblue" },
      ...
      { loc: [41.23929, 13.032145], title: "white" },
    ];
