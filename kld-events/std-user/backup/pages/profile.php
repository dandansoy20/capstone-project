                ...
                <div class="row">
                  ...
                  <div class="col-lg-4 align-self-center">
                    <div class="main-info header-text">
                      <span>3rd Year</span>  <span>BSIS</span>
                      <h4>Riza Mae Alburo</h4>
                      
                      <h6>KLD-21-000999</h6>
                      
                      <h6>rmlalburo@kld.edu.ph</h6>
                      <p>CIS 303</p>
                  ...
                  <div class="col-lg-4 align-self-center">
                    <ul>
                      <li>Events Attended <span>3</span></li>
                      <li>Rated Events <span>2</span></li>
                      <li>Liked Events <span>None</span></li>
                      <li>Invited Events <span>5</span></li>
                    </ul>
                  </div>
                </div>
                <div class="row">
